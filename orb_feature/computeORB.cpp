...
// global variables
string first_file = "/home/xhd/视频/my_vslam/slambooks14-exercise/image/1.png";
string second_file ="/home/xhd/视频/my_vslam/slambooks14-exercise/image/2.png";
...
int main(int argc, char **argv) {
    ...
    chrono::duration<double> time_used_2 = chrono::duration_cast<chrono::duration<double>>(t4 - t3);
    std::cout << "bfMatch cost :" <<  time_used_2.count()  << "s" << std::endl;
...
//         cv::DMatch m(i1, 0, 256); //初始化匹配对;
//         for(size_t i2 = 0; i2 < desc2.size(); i2++){
//             if(desc2[i2].empty()) continue;
//             int distance = 0;
//             for(int k = 0; k < 256; k++){
//                 distance += desc1[i1][k] ^ desc2[i2][k]; //异或：不同为1;
//             }
...
//     for (auto &m: matches) {
//         cout <<"m.queryIdx: "<< m.queryIdx << ", " << "m.trainIdx: "<<m.trainIdx << ", " << "m.distance : " << m.distance << endl;
//     }
//     return;
// }
